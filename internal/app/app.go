...
func (a *App) initInjector(_ context.Context) error {
	a.injector = newInjector()
	return nil
}
...
func (a *App) initHTTPServer(ctx context.Context) error {
	...
	a.httpServer = &http.Server{
		Addr:    a.injector.HTTPConfig().Address(),
...
func (a *App) runGRPCServer() error {
	log.Printf("GRPC server is running on %s", a.injector.GRPCConfig().Address())

	list, err := net.Listen("tcp", a.injector.GRPCConfig().Address())
	if err != nil {
		return err
	}
...
func (a *App) runHTTPServer() error {
	log.Printf("HTTP server is running on %s", a.injector.HTTPConfig().Address())
...
func (a *App) runSwaggerServer() error {
	log.Printf("Swagger server is running on %s", a.injector.SwaggerConfig().Address())
